 ...
 * Describe:
 */
public class EuAmStyleVisitorMeal extends VisitorMeal {
    @Override
    ...
    public String getName() {
        this.setName("Euro and American style meal for visitors");
    ...
    public String getProducedDate() {
        this.setProducedDate("2021-11-06 09:26:12");
    ...
    public void producing() {
        System.out.println("欧美团队正在制作欧美风格游客餐...");
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            e.printStackTrace();
